...
Referencia completa del flujo: criterios, convenciones y decisiones de diseño de cada
paso. Para el panorama general y el paso a paso resumido, ver el [README](README.md).
