...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "tipo_estafa",
  contexto = "respuestas a la pregunta: \"¿Ha sufrido recientemente alguna estafa a través de internet, teléfono celular, WhatsApp o redes sociales?¿qué tipo de estafa te hicieron? \"",  # contexto actualizado
  ejemplo_salida = "Estafa - Premios o Sorteos Falsos",
  chunk_size = 20L
)
