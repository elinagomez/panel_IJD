...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "crecimiento_estafa",
  contexto = "respuestas a la pregunta: \"¿Qué comportamientos o actitudes de las personas crees que han facilitado el crecimiento de estas estafas a través de medios digitales? \"",  # contexto actualizado
  ejemplo_salida = "FALTA COMPORTAMIENTO PREVENTIVO,",
  chunk_size = 20L
)
