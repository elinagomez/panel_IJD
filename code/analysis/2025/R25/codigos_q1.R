...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "conocimiento_estafas",
  contexto = "respuestas a la pregunta: \"¿Qué has oído hablar sobre estafas a través de medios digitales (redes sociales, correo electrónico, whatsapp, celulares)? \"",  # contexto actualizado
  ejemplo_salida = "Tipo de Estafa - Phishing/Bancos/Tarjetas",
  chunk_size = 20L
)
