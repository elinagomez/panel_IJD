...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "acciones_gobierno",
  contexto = "respuestas a la pregunta: \"¿Qué crees que podría hacer el gobierno para prevenir este tipo de delito?\"",  # contexto actualizado
  ejemplo_salida = "Mejorar Capacidad de Investigación/Control",
  chunk_size = 20L
)
