...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "reolucion_estafa",
  contexto = "respuestas a la pregunta: \"Si has sufrido recientemente alguna estafa a través de internet, teléfono celular, WhatsApp o redes sociales ¿Qué hiciste para resolver el problema? \"",  # contexto actualizado
  ejemplo_salida = "revención/Autogestión (Aumento de Cautela/Seguro)",
  chunk_size = 20L
)
