...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "exploracion_petroleo",
  contexto = "respuestas a la pregunta: \"¿Por qué estás de acuerdo o en desacuerdo con explorar o explotar posibles reservas de petróleo en Uruguay?\"",
  ejemplo_salida = "1. ASUMIR EL RIESGO/OPORTUNIDAD",
  chunk_size = 20L
)
