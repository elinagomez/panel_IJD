...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "recuerdo_orsi_bukele",
  contexto = "respuestas a la pregunta: \"Según lo que recuerdas, ¿qué dijo Yamandú Orsi sobre la política de seguridad de Bukele?\"",
  ejemplo_salida = "MODELO A ANALIZAR",
  chunk_size = 20L
)
