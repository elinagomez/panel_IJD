...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "opinion_analisis_bukele",
  contexto = "respuestas a la pregunta: \"¿Qué opinas de analizar el modelo de seguridad de Bukele, como planteó Orsi?\"",
  ejemplo_salida = "ANALIZAR PARA CONCLUIR",
  chunk_size = 20L
)
