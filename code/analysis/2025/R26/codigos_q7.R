...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "turismo_cannabis",
  contexto = "respuestas a la pregunta: \"opiniones sobre permitir o no la venta legal de cannabis a turistas en Uruguay\"",
  ejemplo_salida = "DERECHOS",
  chunk_size = 20L
)
