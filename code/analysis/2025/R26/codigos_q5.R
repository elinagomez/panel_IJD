...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "prioridades_narcotrafico",
  contexto = "respuestas a la pregunta: \"opiniones sobre prioridades de política pública para enfrentar el narcotráfico y el consumo de drogas en Uruguay\"",
  ejemplo_salida = "TRATAMIENTO/MEDICACIÓN",
  chunk_size = 20L
)
