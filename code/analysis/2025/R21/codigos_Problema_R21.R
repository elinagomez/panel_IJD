...
config <- list(
  year = 2025,
  round = "R21",
  pregunta = "Problema_R21",
  base_path = "data/processed",
  campo_salida = "codigo",
  tema = "problemas_semana",
  contexto = "respuestas a la pregunta \"¿En qué área has experimentado problemas esta semana? y ¿qué problema has enfrentado?\"",  # contexto actualizado
  ejemplo_salida = "No hay trabajo - Edad",
  chunk_size = 20L
)
