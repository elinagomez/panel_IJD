...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "mejora_economia",
  contexto = "respuestas a la pregunta \"¿Qué te parece que el gobierno podría hacer para que mejore la economía del país en el corto plazo?\"",  # contexto actualizado
  ejemplo_salida = "generacion_empleo_inversion",
  chunk_size = 20L
)
