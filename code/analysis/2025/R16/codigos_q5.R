...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "comparacion_gobiernos",
  contexto = "comentarios sobre comparación entre gobiernos de Lacalle Pou y Yamandú Orsi",  # contexto actualizado
  ejemplo_salida = "diferentes_enfoque_politico",
  chunk_size = 20L
)
