...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "seguridad",
  contexto = "respuestas a la pregunta \"¿Qué te parece que el gobierno podría hacer para que mejore la seguridad en el país en el corto plazo?\"",  # contexto actualizado
  ejemplo_salida = "mano_dura",
  chunk_size = 20L
)
