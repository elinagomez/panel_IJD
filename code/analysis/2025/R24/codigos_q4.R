...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "situaciones_violencia_escuelas",
  contexto = "respuestas a la pregunta: \"La semana pasada ocurrieron varios hechos de violencia en escuelas públicas que tuvieron notoriedad pública. El más destacado ocurrió en Jardines del hipódromo. En la Escuela 123, hubo escenas de violencia luego de que una madre ingresara acompañada por varios adolescentes, que agredieron y amenazaron a niños, padres y maestros. ¿Por qué crees que ocurren situaciones de violencia en forma periódica en escuelas públicas?\"",  # contexto actualizado
  ejemplo_salida = "Sistema Educativo/Docentes",
  chunk_size = 20L
)
