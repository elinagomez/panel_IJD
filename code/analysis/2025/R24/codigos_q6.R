...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "responsabilidad_violencia",
  contexto = "respuestas a la pregunta: \"De acuerdo a tu opinión ¿dónde están las responsabilidades de que ocurran estas situaciones en las escuelas?
a.	En el personal docente de las escuelas
b.	En los padres
c.	En las autoridades de la enseñanza
d.	En la sociedad en general
e.	otro (especificar)
¿Qué te hace pensar de esa manera?
\"",  # contexto actualizado
  ejemplo_salida = "Deterioro Social Amplio (Estructural/Económico/Político)",
  chunk_size = 20L
)
