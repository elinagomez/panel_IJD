...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "prision_domiciliaria_militares",
  contexto = "respuestas a la pregunta: \"¿Por qué estás de acuerdo o en desacuerdo con otorgar prisión domiciliaria a militares condenados por delitos en la dictadura?\"",
  ejemplo_salida = "MERECIMIENTO / CASTIGO",
  chunk_size = 20L
)
