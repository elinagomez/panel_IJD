...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "politicas_publicas_negativas",
  contexto = "respuestas a la pregunta: \"¿En qué áreas ves problemas o falencias en el gobierno actual?\"",
  ejemplo_salida = "SEGURIDAD",
  chunk_size = 20L
)
