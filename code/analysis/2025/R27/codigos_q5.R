...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "evaluacion_gestion_gobierno",
  contexto = "respuestas a la pregunta: \"¿Por qué calificas así la gestión del gobierno actual?\"",
  ejemplo_salida = "INACCIÓN / LENTITUD",
  chunk_size = 20L
)
