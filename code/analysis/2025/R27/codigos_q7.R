...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "politicas_publicas_positivas",
  contexto = "respuestas a la pregunta: \"¿Qué políticas públicas o acciones del gobierno actual valoras de forma positiva?\"",
  ejemplo_salida = "APOYO GENÉRICO",
  chunk_size = 20L
)
