...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "noticias",
  contexto = "respuestas a la pregunta: \"En los últimos días se han discutido públicamente sobre distintos temas relacionados con el sistema de Salud, ¿Qué tema recuerdas haber escuchado o haber discutido con otros sobre el sistema de salud en los últimos días?\"",  # contexto actualizado
  ejemplo_salida = "Acceso/Atención",
  chunk_size = 20L
)
