...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "topicos_relevantes",
  contexto = "respuestas a la pregunta: \"De los siguientes tópicos relacionados con el el sistema de salud ¿cuál es el más relevante para tí? 
a.	la discusión sobre el acceso a medicamentos a través de los prestadores de salud
b.	la discusión sobre cómo reducir los tiempos de espera para consulta médica, exámenes, etc.
c.	el debate sobre la incompatibilidad de que el presidente de ASSE, Álvaro Danza, ejerza funciones en Asse y en mutualistas
d.	la discusión sobre la ampliación de los servicios de salud mental
e.	la discusión sobre los beneficios que tuvo la mutualista Círculo Católico en el gobierno anterior

¿Por qué crees que es el más importante? 
\"",  # contexto actualizado
  ejemplo_salida = "Tiempos de espera",
  chunk_size = 20L
)
