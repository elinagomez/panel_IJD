...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "actuacion_gobierno",
  contexto = "respuestas a la pregunta: \"El gobierno defendió a Danza, luego le pidió que dejara sus trabajos privados y aceptó su continuidad como presidente de ASSE. ¿Cómo evalúas el accionar del gobierno en este caso? 
a.	Está actuando de manera correcta
b.	No está actuando de manera correcta
c.	No tengo una opinión formada
¿Por qué? 
\"",  # contexto actualizado
  ejemplo_salida = "Acepta decisión gobierno",
  chunk_size = 20L
)
