...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "falta_de_etica_Alvaro_Danza",
  contexto = "respuestas a la pregunta: \"En el caso de Álvaro Danza, presidente de ASSE, la oposición consideró que hubo una falta ética, pidió su renuncia y va a interpelar a la ministra de Salud. ¿Cómo evalúas el accionar de la oposición en este caso?\"",  # contexto actualizado
  ejemplo_salida = "Crítica a OP - Circo Político/Distracción",
  chunk_size = 20L
)
