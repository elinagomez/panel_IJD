...
base_path = Path("/Users/simonherrera/Downloads/base y análisis ronda 12.xlsx")
class_path = Path("data/processed/analysis/2026/R12/clasificacion_R12_2026.xlsx")
out_dir = Path(__file__).resolve().parent

code_questions = ["q1", "q5", "q6", "q7", "q8", "q10", "q12", "q14"]
...
for q in code_questions:
    ...
    for r in range(1, ws.max_row + 1):
        if ws.cell(r, 1).value in ["Etiqueta", "Categoría (Etiqueta)"]:
