...
config <- list(
  ...
  campo_salida = "codigo",
  tema = "rescision_cardama",
  contexto = "respuestas a la pregunta: \"argumentos sobre la rescision o continuidad del contrato con Cardama por las patrulleras\"",  # contexto actualizado
  ejemplo_salida = "01. Incumplimiento de la empresa",
  chunk_size = 20L
)
